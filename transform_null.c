...
static int transop_encode_null(n2n_trans_op_t * arg, uint8_t * outbuf,
...
static int transop_decode_null(n2n_trans_op_t * arg, uint8_t * outbuf,
        size_t out_len, const uint8_t * inbuf, size_t in_len)
{
    int retval = -1;
...
static int transop_addspec_null(n2n_trans_op_t * arg,
